...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(ProfName, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(9, 9, 9)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try{
            ...
            String query = "insert into forgotpassword values(?,?,?)";
            
             PreparedStatement ps = con.prepareStatement(query);
             ps.setInt(1, Integer.parseInt(id.getText()));
             System.out.println(id.getText());
             String tempPwd = password.toString();
             System.out.println(tempPwd);
             ps.setString(2, tempPwd);
             ps.setString(3, ProfName.getText());
             
             
             ps.execute();
             
             JOptionPane.showMessageDialog(this, "Sent for Approval");
